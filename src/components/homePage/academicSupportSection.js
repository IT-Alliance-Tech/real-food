  ...
  return (
    <section className="relative w-full py-20 md:py-28 bg-[#2D6933] overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 text-white">
        ...
        <div className="text-center mb-20 animate-fade-up">
          ...
          <p className="max-w-3xl mx-auto text-lg text-white/85 leading-relaxed">
            Our work extends beyond individual education to empower
            institutions, enhance academic programs, and drive professional
            development in integrative health.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-slide-right group">
            {/* Dynamic glow */}
            <div className="absolute -inset-4 rounded-[40px] bg-white/20 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            <div className="absolute inset-0 rounded-[32px] bg-white/10 blur-xl" />

            {/* Image container */}
            <div className=" bg-yellow relative h-[250px] sm:h-[300px] rounded-[32px] overflow-hidden border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-[0_30px_60px_rgba(0,0,0,0.4)] group-hover:border-white/40 animate-float">
              <Image
                src={AcademicImage}
            ...
            {/* Decorative element */}
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-[#F9A620]/20 rounded-full blur-2xl animate-pulse" />
          </div>
        </div>
      </div>
      ...
      <style>{`
                ...
                .animate-slide-right {
                  opacity: 0;
                  animation: slideRight 0.9s cubic-bezier(0.16, 1, 0.3, 1) forwards;
                }
